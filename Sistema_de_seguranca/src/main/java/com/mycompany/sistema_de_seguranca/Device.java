...
import events.DirectMethodStatusCallback;
...
public class Device extends javax.swing.JFrame {
    ...
    private static String connString = "HostName=smart-termoazureiot.azure-devices.net;DeviceId=MyJavaDevice;SharedAccessKey=xfS4vgIqCxgcembBApUsDqXGPCSOrn0w4mhUghvCmdk=";
    ...
    private void simulateDevice() throws InterruptedException {
        ...
        try {
            ...
            while (true) {
                ...
                telemetryDataPoint.alert= alert;
                telemetryDataPoint.date = date;
                

                // verificar se distancia é inferior a safetyDistance
                ...
                msg.setProperty("", (distance > 30) ? "true" : "false");
